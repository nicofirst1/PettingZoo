...
class SimpleEnv(AECEnv):
    ...
    def reset(self, landmarks_positions=None, agent_positions=None):
        self.scenario.reset_world(
            self.world, self.np_random, landmarks_positions, agent_positions)
    ...
    def step(self, action):
        ...
        # fix : unnecessary we already change the agent outside
